...
from .serverless_compute import ServerlessComputeSettings
...
class Workspace(Resource):
    ...
    :param serverless_compute_settings: The serverless compute settings for the workspace.
    :type serverless_compute_settings: ~azure.ai.ml.entities.ServerlessComputeSettings
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.serverless_compute_settings: Optional[ServerlessComputeSettings] = serverless_compute_settings
    ...
    def _from_rest_object(cls, rest_obj: RestWorkspace) -> "Workspace":
        ...
        if rest_obj.serverless_compute_settings and isinstance(
            ...
            serverless_compute_settings: ServerlessComputeSettings = (
                ServerlessComputeSettings._from_rest_object(  # pylint: disable=protected-access
